package com.example.fangyi.waterheater.WaveView;
...
/**
 * Created by FANGYI on 2016/4/6.
 */
public class Wave extends View {
    private final int WAVE_HEIGHT_LARGE = 18;   //浪高
    private final int WAVE_HEIGHT_MIDDLE = 8;   //波高中间
    private final int WAVE_HEIGHT_LITTLE = 8;   //波高
