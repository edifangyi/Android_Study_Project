                ...
                try {
                    ...
                    if (conn.getResponseCode() == 200) {
                        ...
                        for (int i = 0; i < threadCount; i++) {
                            ...
                            System.out.println("线程" + i + "的开始位置" + startIndex + "-----------" + endIndex);
        ...
        public void run() {
            ...
            try {
                ...
                if (conn.getResponseCode() == 206) {
                    ...
                    System.out.println("currentProgress  1  " + currentProgress + "    ^^^^^^^^^^^^^^^^^^");
...
//                        System.out.println("线程" + threadId + "已经下载" + total);
                    ...
                    System.out.println("currentProgress  2  " + currentProgress + "    ^^^^^^^^^^^^^^^^^^");
